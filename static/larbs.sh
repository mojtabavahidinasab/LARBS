...
dotfilesrepo="https://github.com/mojtabavahidinasab/voidrice.git"
progsfile="https://raw.githubusercontent.com/mojtabavahidinasab/LARBS/master/static/progs.csv"
aurhelper="yay"
repobranch="master"
export TERM=ansi
